...
namespace odb
{
        ...
        my_bool* t)
  {
    ...
    if (t[2UL])
    {
      i.student_name_value.capacity (i.student_name_size);
      grew = true;
    }
        ...
        image_type& i)
  {
    ...
    b[n].buffer_type = MYSQL_TYPE_LONGLONG;
    b[n].is_unsigned = 1;
    b[n].buffer = &i.student_sn_value;
    b[n].is_null = &i.student_sn_null;
    n++;

    // student_name
    //
    b[n].buffer_type = MYSQL_TYPE_STRING;
    b[n].buffer = i.student_name_value.data ();
    b[n].buffer_length = static_cast<unsigned long> (
      i.student_name_value.capacity ());
    b[n].length = &i.student_name_size;
    b[n].is_null = &i.student_name_null;
    n++;
    ...
    b[n].buffer_type = MYSQL_TYPE_SHORT;
    b[n].is_unsigned = 1;
    b[n].buffer = &i.student_age_value;
    b[n].is_null = &i.student_age_null;
    n++;
  ...
  bool access::view_traits_impl< ::student_name, id_mysql >::
  grow (image_type& i,
        my_bool* t)
  {
    ODB_POTENTIALLY_UNUSED (i);
  ...
  void access::view_traits_impl< ::student_name, id_mysql >::
  bind (MYSQL_BIND* b,
        image_type& i)
  {
    using namespace mysql;
  ...
  access::view_traits_impl< ::student_name, id_mysql >::query_base_type
  access::view_traits_impl< ::student_name, id_mysql >::
  query_statement (const query_base_type& q)
  {
    query_base_type r (
  ...
  result< access::view_traits_impl< ::student_name, id_mysql >::view_type >
  access::view_traits_impl< ::student_name, id_mysql >::
  query (database& db, const query_base_type& q)
  {
    using namespace mysql;
