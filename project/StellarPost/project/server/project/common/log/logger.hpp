    ...
    namespace Log
    {
        ...
        public:
            /*
                ...
                level          日志级别(默认错误级别)
                logFilePath    日志文件路径(默认 "./Logs/Log.log")
            ...
            */
            static Log &GetInstance(
                ...
                const std::string &logFilePath = "./Logs/Log.log",
        ...
        static Log &lg = stellar_post::Log::Log::GetInstance();
        // static Log &lg = stellar_post::Log::Log::GetInstance(true, spdlog::level::trace); // for debug
    }

#define TRACE(fromat, ...) Log::lg("trace", Log::FileName(), Log::Line(), fromat, ##__VA_ARGS__)
#define DEBUG(fromat, ...) Log::lg("debug", Log::FileName(), Log::Line(), fromat, ##__VA_ARGS__)
#define INFO(fromat, ...) Log::lg("info", Log::FileName(), Log::Line(), fromat, ##__VA_ARGS__)
#define WARNING(fromat, ...) Log::lg("warning", Log::FileName(), Log::Line(), fromat, ##__VA_ARGS__)
#define ERROR(fromat, ...) Log::lg("error", Log::FileName(), Log::Line(), fromat, ##__VA_ARGS__)
#define FATAL(fromat, ...) Log::lg("fatal", Log::FileName(), Log::Line(), fromat, ##__VA_ARGS__)
}