...
{
    static cloud_disk::Log::Log &lg = cloud_disk::Log::Log::GetInstance(FLAGS_debug_enable);

    cloud_disk::Etcd::Registry::registryPtr registry = std::make_shared<cloud_disk::Etcd::Registry>(FLAGS_ectdHost);
