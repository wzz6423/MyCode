...
auto main(int argc, char *argv[]) -> int
{
    ...
    // 构建 rpc 信道管理对象
    cloud_disk::Brpc::ChannelManager::managerPtr ptr = std::make_shared<cloud_disk::Brpc::ChannelManager>();
    ptr->Declared(FLAGS_callService);

    auto putCb = std::bind(&cloud_disk::Brpc::ChannelManager::Online, ptr.get(), std::placeholders::_1, std::placeholders::_2);
    auto delCb = std::bind(&cloud_disk::Brpc::ChannelManager::Offline, ptr.get(), std::placeholders::_1, std::placeholders::_2);
